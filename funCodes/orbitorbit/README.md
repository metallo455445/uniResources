...
Il programma calcola la posizione e la traiettoria di uno o più corpi in orbita, gestendo parametri come la velocità, la distanza e l'attrazione gravitazionale. Riporta inoltre i valori i momento totale e di energia per verificarne la conservazione (come ci si aspetta dalla teoria). Può essere pensato per studiare il moto orbitale in un contesto fisico semplificato o per rappresentare graficamente il percorso di un corpo celeste.
