...
Ponendo $\sigma_{px} = 0.5$px, $\sigma_{Dmm} = 1$mm e $\sigma_{Dpx} = \sqrt{4^2 + 4^2} \approx 5.66$px (come spiegato in precedenza si è stimato l'errore sui punti della catenaria pari a 4px) si ricava 

\[ \sigma_{Smm} = \sqrt{1.31^2 + 2.29^2 + 0.53^2} \approx 2.7 \]
